...
pub const applyEnv = http_app.applyEnv;
pub const EnvError = http_app.EnvError;
...
pub const Identity = http_security.auth.Identity;
pub const IdentityResolver = http_security.auth.IdentityResolver;
